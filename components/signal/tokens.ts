/* ============================================================
   SIGNAL — shared tokens + verbatim copy
   Self-contained: nothing here is imported by any other route.
   Colors + copy mirror the blueprint/orbit variants per
   brand-messaging.md — values below must stay byte-identical to
   components/orbit/tokens.ts (the source of truth); mirrored, not
   imported, to keep this route's scope fully disjoint from orbit's.
   ============================================================ */
...
/* H1 + subhead — verbatim from the live homepage (mirrors
   components/orbit/tokens.ts, itself mirrored from
   app/v/blueprint/BlueprintClient.tsx Hero) */
export const H1 =
...
/* Work ring — reused verbatim from BlueprintClient's CASES / DentalTile content */
export const WORK = [
  {
...
/* Capability-voice captions for each conduit scene — no outcome claims,
   only what the systems literally do. */
export const CAPTIONS = {
  intake: "A lead lands.",
  router: "AI answers in seconds.",
  pipeline: "Follow-ups fire themselves.",
  vault: "Proof — the locked numbers.",
  delivery: "Booked. You never touched it.",
} as const;
