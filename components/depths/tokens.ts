/* ============================================================
   DEPTHS — shared tokens + verbatim copy
   Self-contained: nothing here is imported by any other route.
   Surface color matches the blueprint/orbit paper canvas; the
   deep-water gradient is new to this variant (descent narrative)
   but the jade accent is the same brand jade used everywhere else
   — do not invent a new brand accent color here.
   ============================================================ */
...
/* Work stations — reused verbatim from BlueprintClient's CASES / DentalTile
   content (identical source as components/orbit/tokens.ts WORK). */
export const WORK = [
  {
