...
/* ----------------------------------------------------------------------------
   VARIANT: warm-glass-dusk
   Warm charcoal-brown base (#14100D) + terracotta → amber → dusty-rose gradient.
   Earthy sunset palette — NOT neon. Glassmorphism + spring motion preserved.
   Signature: HORIZONTAL-scroll work gallery (spring-driven x pan).
   Fonts: Newsreader (display serif) · Hanken Grotesk (body) · JetBrains Mono (labels).
   Images used (14 distinct — identical set to gradient-glass):
...
/* ── Fonts (module-scope, no layout.tsx dependency) ── */
...
const AMBER = "#E0A050";
const ROSE = "#B5806E";
const GRAD = `linear-gradient(100deg,${TERRA} 0%,${AMBER} 52%,${ROSE} 100%)`;
const GRAD_SOFT = `linear-gradient(100deg,${TERRA},${AMBER} 55%,${ROSE})`;
...
const glassCard: React.CSSProperties = {
  background: SURFACE,
  border: "1px solid rgba(224,160,80,0.16)",
  backdropFilter: "blur(20px)",
  WebkitBackdropFilter: "blur(20px)",
  boxShadow:
    "inset 0 1px 0 rgba(255,255,255,0.06), 0 30px 80px -40px rgba(0,0,0,0.88)",
};
...
/* ============================================================
   PAGE
   ============================================================ */
export default function WarmGlassDuskPage() {
...
function Nav() {
  return (
    <header className="sticky top-0 z-50 px-5 pt-4 sm:px-8">
      ...
      >
        <Link
          href="/v/warm-glass-dusk"
          className="text-sm font-semibold tracking-tight"
          style={{ color: TEXT, fontFamily: "var(--font-jetbrains)" }}
        >
        ...
        <div
          ...
          style={{ color: MUTED, fontFamily: "var(--font-hanken)" }}
        >
...
function Hero({ reduce }: { reduce: boolean }) {
  ...
  return (
    <section ref={ref} className="relative px-5 pb-20 pt-16 sm:px-8 sm:pt-24">
      {/* gradient blooms — earthy sunset hues */}
      <Bloom
        style={{
          width: 560,
          height: 560,
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <motion.div
            ...
            style={{ color: MUTED, fontFamily: "var(--font-jetbrains)" }}
          >
            {[
              ["180+", "workflows"],
              ["40+", "sites"],
        ...
        >
          ...
          <div
            ...
            style={{
              background: GRAD,
              boxShadow: `0 48px 140px -48px ${TERRA}88`,
            }}
          >
            <div
          ...
          >
            <div className="rounded-2xl px-4 py-3" style={glassCardHi}>
              <div
                className="text-xs"
                style={{ color: AMBER, fontFamily: "var(--font-jetbrains)" }}
              >
                47-step n8n engine
              </div>
              <div
                className="mt-0.5 text-sm font-semibold"
                style={{ color: TEXT, fontFamily: "var(--font-hanken)" }}
              >
                self-healing inbox
              </div>
            </div>
          ...
          >
            <div
              className="text-xs"
              style={{ color: ROSE, fontFamily: "var(--font-jetbrains)" }}
            >
              Bali → worldwide
            </div>
          </div>
...
function Marquee({ reduce }: { reduce: boolean }) {
  ...
  return (
    <section
      ...
      style={{ borderColor: "rgba(224,160,80,0.12)" }}
      aria-hidden
    >
      <motion.div
    ...
    >
      ...
      <div className="relative aspect-[16/11] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(20,16,13,0) 30%,rgba(20,16,13,0.88) 100%)",
          }}
        />
        {/* warm gradient tag pill */}
        <span
      ...
      <div className="p-6">
        <div className="flex items-start justify-between gap-3">
          <h3
            ...
            style={{ color: TEXT, fontFamily: "var(--font-newsreader)" }}
          >
            {w.title}
          </h3>
          <span
      ...
      <div className="mx-auto flex max-w-6xl gap-4">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg,rgba(20,16,13,0.55) 0%,transparent 60%)",
            }}
          />
          <span
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg,transparent 40%,rgba(20,16,13,0.75) 100%)",
            }}
          />
          <span
    ...
    <section id="process" className="relative px-5 py-24 sm:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <div
            className="text-xs uppercase tracking-[0.25em]"
            style={{ color: TERRA, fontFamily: "var(--font-jetbrains)" }}
          >
            How it works
          </div>
          <h2
...
/* ── Wire up CTA (avoids naming collision with `CTA` local variable) ── */
function CTA() {
  return <CtaSection />;
}
