...
const fraunces = Fraunces({
  ...
  subsets: ["latin"],
  // Heavy display weights — the thin look came from loading only 300/400.
    ...
    <section ref={ref} className="relative px-5 pb-20 pt-16 sm:px-8 sm:pt-24">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <motion.h1
            variants={rise}
            className="mt-6 font-black leading-[0.95] tracking-[-0.02em]"
            style={{
              fontSize: "clamp(3.1rem,7.8vw + 0.5rem,5.6rem)",
              color: TEXT,
              fontFamily: "var(--font-fraunces)",
            }}
          >
        ...
        >
          {steps.map((s) => (
            ...
            >
              ...
              <div
                className="absolute -right-5 -top-6 select-none text-8xl font-extrabold opacity-[0.18]"
                aria-hidden
                style={{ fontFamily: "var(--font-fraunces)" }}
              >
                <GradText>{s.n}</GradText>
        ...
        >
          ...
          >
            ...
            <div className="relative">
              ...
              <h2
                className="mx-auto max-w-3xl font-extrabold leading-[1.02]"
                style={{
