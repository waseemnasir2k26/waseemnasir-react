...
/* ----------------------------------------------------------------------------
   VARIANT: obsidian-aurum
   True obsidian base (#0A0A0B) + champagne → bronze → pale-gold metallic
   gradient system. Anti-AI palette: all warm metal, zero neon.
   Signature: HORIZONTAL-scroll work gallery (spring-driven x pan).
   Images used (14 distinct): identical to gradient-glass.
---------------------------------------------------------------------------- */
...
const TEXT = "#F3F0EA";
const MUTED = "#B8B2A6"; /* warm stone — clears WCAG AA on #0A0A0B */
const CHAMP = "#CBA968"; /* champagne */
const BRONZE = "#9C6F3A"; /* bronze */
const PALE = "#E6D2A8"; /* pale gold */
const GRAD = `linear-gradient(100deg,${CHAMP} 0%,${BRONZE} 48%,${PALE} 100%)`;
...
const glassCard: React.CSSProperties = {
  background: SURFACE,
  border: "1px solid rgba(203,169,104,0.18)",
  backdropFilter: "blur(20px)",
  WebkitBackdropFilter: "blur(20px)",
  boxShadow:
    "inset 0 1px 0 rgba(203,169,104,0.08), 0 30px 80px -40px rgba(0,0,0,0.9)",
};

const glassCardHi: React.CSSProperties = {
  ...glassCard,
  background: SURFACE_HI,
  border: "1px solid rgba(203,169,104,0.26)",
};
...
/* ============================================================
   PAGE
   ============================================================ */
export default function ObsidianAurumPage() {
  ...
  return (
    ...
    >
      {/* Brand background — covers global dark body + aurora from layout.tsx */}
      <div
...
function Hero({ reduce }: { reduce: boolean }) {
  ...
  return (
    <section ref={ref} className="relative px-5 pb-20 pt-16 sm:px-8 sm:pt-24">
      {/* Champagne / bronze blooms — tasteful low opacity */}
      <Bloom
        style={{
          width: 560,
          height: 560,
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          {/* headline — Cormorant Garamond, bumped size for light weight legibility */}
          <motion.h1
            variants={rise}
            className="mt-6 font-light leading-[0.97] tracking-tight"
            style={{
              fontFamily: "var(--font-cormorant), Georgia, serif",
              fontSize: "clamp(3.2rem,8vw + 0.5rem,5.6rem)",
              color: TEXT,
            }}
          >
            I make your <br />
        ...
        >
          {/* champagne gradient ring border */}
          <div
            className="relative rounded-[2rem] p-[3px]"
            style={{
              background: GRAD,
              boxShadow: `0 48px 140px -48px ${BRONZE}88`,
            }}
          >
            <div
...
function Marquee({ reduce }: { reduce: boolean }) {
  ...
  return (
    <section
      ...
      style={{ borderColor: "rgba(203,169,104,0.12)" }}
      aria-hidden
    >
      <motion.div
        ...
        <div className="relative mx-auto mb-8 flex w-full max-w-6xl items-end justify-between">
          <div>
            ...
            <h2
              ...
              style={{
                fontFamily: "var(--font-cormorant), Georgia, serif",
                fontSize: "clamp(2.1rem,4vw + 0.5rem,3.8rem)",
              }}
            >
    ...
    >
      ...
      <div className="relative aspect-[16/11] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(10,10,11,0) 30%,rgba(10,10,11,0.88) 100%)",
          }}
        />
        {/* metallic tag pill */}
        <span
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-2">
        ...
        >
          ...
          <motion.h2
            ...
            style={{
              fontFamily: "var(--font-cormorant), Georgia, serif",
              fontSize: "clamp(2.2rem,4vw + 0.5rem,3.8rem)",
            }}
          >
      ...
      <div className="mx-auto flex max-w-6xl gap-4">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg,rgba(10,10,11,0.55) 0%,transparent 60%)",
            }}
          />
          <span
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg,transparent 40%,rgba(10,10,11,0.75) 100%)",
            }}
          />
          <span
        ...
        >
          {steps.map((s) => (
            <motion.div
              ...
              style={glassCard}
            >
              {/* giant outline number — champagne gradient */}
              <div
  ...
  return (
    <section className="relative px-5 py-24 sm:px-8">
      <div className="relative mx-auto max-w-5xl">
        {/* champagne gradient-bordered panel */}
        <div
          ...
          >
            ...
            <div className="relative">
              ...
              <h2
                ...
                style={{
                  fontFamily: "var(--font-cormorant), Georgia, serif",
                  fontSize: "clamp(2.6rem,5vw + 0.5rem,4.6rem)",
                }}
              >
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
        ...
        >
          <a href={CTA_URL} className="transition-colors hover:text-white">
            Book a call
          </a>
          <a
