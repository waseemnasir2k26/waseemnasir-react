...
const WHATSAPP_HREF =
  "https://wa.me/6281316077185?text=Hi%20Waseem%2C%20I%27m%20reaching%20out%20from%20waseemnasir.com";
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {/* WhatsApp CTA — Waseem, 2026-09-21 */}
          <a
            href={WHATSAPP_HREF}
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Contact us on WhatsApp, +62 813-1607-7185"
            className="bp-cta inline-flex items-center gap-1.5 rounded-full font-semibold transition-opacity hover:opacity-90"
            style={{
              background: "#25D366",
              color: "#0b2e1a",
              fontSize: "0.85rem",
