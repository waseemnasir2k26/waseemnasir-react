...
/* ----------------------------------------------------------------------------
   VARIANT: ink-atelier
   Deep ink-navy base (#0B1018) + muted steel-blue → deep teal → brass gradient.
   Glassmorphism cards with brass hairline borders over restrained blooms.
   Signature: HORIZONTAL-scroll work gallery (spring-driven x pan).
   Identity: refined navy-steel + brass — architectural, not AI-SaaS.
   Images: identical to gradient-glass (same /img/pro/ paths).
---------------------------------------------------------------------------- */

/* ── Fonts (next/font/google, module-scope) ── */
...
const TEXT = "#EEF1F4";
const MUTED = "#AAB6C2";
// Gradient anchors — steel-blue, deep teal, brass
const STEEL = "#3A5A78";
const TEAL = "#2E6E70";
const BRASS = "#B08D4F";
const GRAD = `linear-gradient(100deg,${STEEL} 0%,${TEAL} 48%,${BRASS} 100%)`;
const GRAD_SOFT = `linear-gradient(100deg,${STEEL},${TEAL} 55%,${BRASS})`;
// Brass hairline border for glass cards
const BRASS_BORDER = "rgba(176,141,79,0.16)";
...
/* GradText — brass/teal gradient on display text */
...
/* Glass card style — cool-neutral bg, brass hairline */
...
/* ============================================================
   PAGE
   ============================================================ */
export default function InkAtelierPage() {
  ...
  return (
    <>
      ...
      <div
        className={`relative z-10 ${spectral.variable} ${archivo.variable} ${jetbrainsMono.variable}`}
        style={{ color: TEXT }}
      >
        <main
          id="main-content"
...
function Hero({ reduce }: { reduce: boolean }) {
  ...
  return (
    <section ref={ref} className="relative px-5 pb-20 pt-16 sm:px-8 sm:pt-24">
      {/* Restrained architectural blooms — no neon */}
      <Bloom
        style={{
          width: 560,
          height: 560,
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <motion.p
            ...
            style={{ color: MUTED, fontFamily: "var(--font-archivo)" }}
          >
          ...
          {/* mono stats — JetBrains Mono, Spectral for numbers */}
          <motion.div
            variants={rise}
        ...
        {/* RIGHT: portrait with brass gradient ring */}
        <motion.div
          style={{ y: yPortrait }}
        ...
        >
          {/* brass gradient ring border */}
          <div
            className="relative rounded-[2rem] p-[3px]"
            style={{
              background: GRAD,
              boxShadow: `0 48px 140px -48px ${TEAL}66`,
            }}
          >
            <div
...
function Marquee({ reduce }: { reduce: boolean }) {
  ...
  return (
    <section
      ...
      style={{ borderColor: BRASS_BORDER }}
      aria-hidden
    >
      <motion.div
    ...
    >
      ...
      <div className="relative aspect-[16/11] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(11,16,24,0) 30%,rgba(11,16,24,0.88) 100%)",
          }}
        />
        {/* brass tag pill */}
        <span
...
/* ============================================================
   LIFE STRIP — 2/3-image full-bleed accent strip
   ============================================================ */
function LifeStrip() {
  return (
      ...
      <div className="mx-auto flex max-w-6xl gap-4">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg,rgba(11,16,24,0.55) 0%,transparent 60%)",
            }}
          />
          <span
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg,transparent 40%,rgba(11,16,24,0.75) 100%)",
            }}
          />
          <span
        ...
        >
          {steps.map((s) => (
            <motion.div
              ...
              style={glassCard}
            >
              {/* giant gradient outline number — Spectral */}
              <div
                className="absolute -right-5 -top-6 select-none font-light text-8xl opacity-[0.18]"
                style={{ fontFamily: "var(--font-spectral)" }}
                aria-hidden
              >
                <GradText>{s.n}</GradText>
