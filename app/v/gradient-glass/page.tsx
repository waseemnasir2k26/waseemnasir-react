...
/* ----------------------------------------------------------------------------
   ...
   Near-black base (#0B0B12) + vivid pink→violet→electric-blue gradient system.
   Photos inside glassmorphism cards over gradient blooms.
   Signature: HORIZONTAL-scroll work gallery (spring-driven x pan).
   Images used (14 distinct):
...
const VIOLET = "#7C5CFF";
const BLUE = "#2EC5FF";
const GRAD = `linear-gradient(100deg,${PINK} 0%,${VIOLET} 48%,${BLUE} 100%)`;
const GRAD_SOFT = `linear-gradient(100deg,${PINK},${VIOLET} 55%,${BLUE})`;
...
const glassCard: React.CSSProperties = {
  ...
  boxShadow:
    "inset 0 1px 0 rgba(255,255,255,0.07), 0 30px 80px -40px rgba(0,0,0,0.85)",
};
...
/* ============================================================
   PAGE
   ============================================================ */
export default function GradientGlassPage() {
    ...
    <header className="sticky top-0 z-50 px-5 pt-4 sm:px-8">
      ...
      >
        ...
        <a
          ...
          className="rounded-full px-4 py-2 text-sm font-semibold text-black transition-transform hover:scale-[1.04] active:scale-95"
    ...
    <section ref={ref} className="relative px-5 pb-20 pt-16 sm:px-8 sm:pt-24">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <motion.h1
            variants={rise}
            className="mt-6 font-serif font-light leading-[0.97] tracking-tight"
            style={{
          ...
          >
            <a
              href="https://skynetjoe.com/discovery-call"
              className="group inline-flex items-center gap-2 rounded-full px-6 py-3.5 text-base font-semibold text-black transition-transform hover:scale-[1.04] active:scale-95"
              style={{ background: GRAD }}
            >
              Book a 30-min call
              <span
          ...
          <motion.div
            variants={rise}
            className="mt-10 flex flex-wrap gap-x-8 gap-y-3 font-mono text-sm"
            style={{ color: MUTED }}
          >
            {[
              ["180+", "workflows"],
        ...
        >
          ...
          <div
            ...
            style={{
              background: GRAD,
              boxShadow: `0 48px 140px -48px ${VIOLET}88`,
            }}
          >
            <div
          ...
          >
            <div className="rounded-2xl px-4 py-3" style={glassCardHi}>
              <div className="font-mono text-xs" style={{ color: BLUE }}>
                47-step n8n engine
              </div>
              <div
          ...
          <div
            ...
            style={glassCardHi}
          >
            <div className="font-mono text-xs" style={{ color: PINK }}>
              Bali → worldwide
            </div>
          </div>
        </motion.div>
...
function Marquee({ reduce }: { reduce: boolean }) {
  ...
  return (
    ...
    >
      <motion.div
        className="flex w-max gap-10 whitespace-nowrap font-mono text-sm"
        style={{ color: MUTED }}
...
function WorkGallery({ reduce }: { reduce: boolean }) {
  ...
  // Spring-smooth the raw transform for the horizontal pan
    ...
    <section id="work" ref={ref} style={{ height: reduce ? "auto" : "320vh" }}>
      ...
      >
        ...
        <div className="relative mx-auto mb-8 flex w-full max-w-6xl items-end justify-between">
          <div>
            ...
            <h2
              ...
              style={{ fontSize: "clamp(1.9rem,4vw + 0.5rem,3.5rem)" }}
            >
        ...
        {reduce ? (
          ...
          /* horizontal panning track — spring x */
          <div className="relative overflow-visible">
            ...
            >
              ...
              {/* spacer so last card fully clears right edge */}
    ...
    >
      ...
      <div className="relative aspect-[16/11] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(11,11,18,0) 30%,rgba(11,11,18,0.88) 100%)",
          }}
        />
        {/* gradient tag pill */}
        <span
      ...
      <div className="p-6">
        <div className="flex items-start justify-between gap-3">
          ...
          <span
            ...
            style={{ color: BLUE, marginTop: "0.2rem" }}
          >
            {w.region}
          </span>
        </div>
    ...
    <section id="about" className="relative px-5 py-24 sm:px-8">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-2">
        ...
        >
          ...
          <motion.h2
            variants={rise}
            className="mt-3 font-serif font-light leading-tight"
      ...
      <div className="mx-auto flex max-w-6xl gap-4">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg,rgba(11,11,18,0.55) 0%,transparent 60%)",
            }}
          />
          <span
            className="absolute bottom-4 left-5 font-mono text-xs uppercase tracking-widest"
            style={{ color: TEXT, textShadow: "0 1px 8px rgba(0,0,0,0.8)" }}
          >
            Bali · rooftop office
          </span>
        </motion.div>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg,transparent 40%,rgba(11,11,18,0.75) 100%)",
            }}
          />
          <span
            className="absolute bottom-4 left-4 font-mono text-xs uppercase tracking-widest"
            style={{ color: TEXT, textShadow: "0 1px 8px rgba(0,0,0,0.8)" }}
          >
            Community · Bali
          </span>
        ...
        >
          {steps.map((s) => (
            ...
            >
              ...
              <div
                className="absolute -right-5 -top-6 select-none font-serif text-8xl font-light opacity-[0.18]"
                aria-hidden
              >
                <GradText>{s.n}</GradText>
              </div>
        ...
        >
          ...
          >
            ...
            <div className="relative">
              <div
                className="mx-auto mb-4 font-mono text-xs uppercase tracking-[0.25em]"
                style={{ color: BLUE }}
              >
                Ready to start
              </div>
              <h2
                className="mx-auto max-w-3xl font-serif font-light leading-[1.02]"
              ...
              <a
                href="https://skynetjoe.com/discovery-call"
                className="mt-10 inline-flex items-center gap-2 rounded-full px-8 py-4 text-lg font-semibold text-black transition-transform hover:scale-[1.04] active:scale-95"
                style={{ background: GRAD }}
              >
                Book a 30-min call →
              </a>
              <div className="mt-5 font-mono text-sm" style={{ color: MUTED }}>
                or email{" "}
                <a
